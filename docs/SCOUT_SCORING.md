...
## 11. お宝スコア (Treasure Score) — 2026-06-15 設計

### 何のための指標か

「1スカウト最低1個はお宝を掘り当てたい」 という事業の本質目的を**機械化**するための複合スコア。

### KD の扱い (2026-06-15 改定)

DFS Labs の日本語 KW インデックスは**ロングテール KW のカバレッジが薄い**ことが実証検証で判明。
特に「○○ おすすめ」 「○○ 安い」 等の主婦向け CVKW は KD=0/null になるため、Backlinks サブスクは
本契約しない方針 (詳細は `docs/GLOSSARY.md` の「Backlinks サブスクリプション」 参照)。

→ **KD は「取れたらラッキー」 の補助指標扱い**。お宝スコアは KD 抜き 70点満点運用でも
60点超え (💎💎 お宝判定) が成立する設計にしてある。

### 5軸の合算 (最大 110点)

| 軸 | 加点ルール | 最大点 | 意味 |
|---|---|---|---|
| **KD** | ≤10: +40 / ≤20: +30 / ≤30: +15 | 40 | SEO 勝率 (個人ブログで戦える難易度) |
...
| スコア | ランク | UI |
|---|---|---|
| 80-110 | 💎💎💎 **超お宝** | 紫グラデ強調バッジ (KD実数値取れた時のみ到達可) |
| 60-79 | 💎💎 **お宝** | エメラルド強調 (KD抜きでも到達可) |
| 40-59 | 💎 **準お宝** | 黄色 |
| <40 | 通常採用 | 灰色 |

**実運用満点**: KD抜きでは **70点満点** (SV最大30 + CVKW最大20 + SERP最大15 + AI Overview最大5)。
60点超え (= 💎💎 お宝判定) に到達するには「SV ≥500 + CVKW ≥50 + SERP個人ブログ ≥2件」 が目安。

### Stage 5 (Gemini #3) 判定ルールへの組み込み

- adopt: treasureTotal ≥ 60 (💎💎 お宝以上は必ず採用)
- borderline: treasureTotal 40-59 (Top10 状況次第)
- reject: treasureTotal < 40
- **保証ルール**: 全候補の最大が 40 以上なら、最低 1件は adopt にする (お宝発掘がスカウトの本質目的)

### スコア試算例

| KW | KD | SV | CVKW | 個人ブログ | 合計 | 評価 |
|---|---|---|---|---|---|---|
| 「ピジョン 母乳実感 価格 amazon」 | 12 | 1,500 | 90 | 4件 | 40+20+18+15=**93** | 💎💎💎 超お宝 |
| 「ピジョン 母乳実感 8ヶ月」 | 18 | 800 | 50 | 3件 | 30+10+10+10=**60** | 💎💎 お宝 |
| 「ベビーカー」 (大ボリュームだが KD 高) | 78 | 20,000 | 20 | 0件 | 0+30+4+0=**34** | 通常 (勝てない) |
| 「ピジョン 母乳実感 SS 中古」 (超ニッチ) | 5 | 50 | 70 | 5件 | 40+0+14+15=**69** | 💎💎 お宝 (超ニッチでも勝てる) |
...
> 「商品名を入れるだけで、Google 公式データから **「個人ブログでも勝てる + 流入が取れる + 購入意図が強い」 KW** を機械的に発掘します。各 KW がなぜ採用 (or 不採用) なのか、5軸の加点内訳まで全部可視化されます。**「KD=18 だから個人ブログで2-4ヶ月で勝てる」「Top10 に個人ブログ3件いるから勝てる証拠あり」** といった根拠付きで提案できます。」
